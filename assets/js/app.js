const PROJECTS = [
  ...
  },
  {
    ...
    titleKo: "원자력연구원 우주탐사로버 ROS 원격 운영",
    titleEn: "KAERI ROS Remote Operation for Space Exploration Rover",
    roleKo: "ROS 데이터 연동 & 원격 운영",
    roleEn: "ROS Data Integration & Remote Operation",
    periodKo: "2024.01 - 2024.03 | 3개월",
    periodEn: "Jan 2024 - Mar 2024 | 3 months",
    teamKo: "2명",
    teamEn: "2 members",
    summaryKo:
      "로봇 카메라 영상과 ROS 토픽 데이터를 원격 운영 화면에 연동하고, roslib.js로 모터 RPM 등 상태 데이터를 실시간 확인할 수 있게 구현했습니다. 대한민국 과학축제 KAERI 부스에서 로버 운용 데모에 활용되었습니다.",
    summaryEn:
      "Integrated robot camera streams and ROS topic data into a remote operation view, using roslib.js to monitor status values such as motor RPM in real time. The system supported a rover operation demo at the KAERI booth during the Korea Science Festival.",
    stack: "ROS, roslib.js, WebRTC, Ngrok",
    outcomeKo: "로버 원격 운영 데모 전시",
    outcomeEn: "Rover remote operation demo",
  ...
  },
  {
    ...
    roleKo: "SLAM 평가 & 로봇 실험",
    roleEn: "SLAM Evaluation & Robot Experiments",
    periodKo: "2024.01 - 2024.06 | 6개월",
    periodEn: "Jan 2024 - Jun 2024 | 6 months",
    teamKo: "3명",
    teamEn: "3 members",
    summaryKo:
      "OpenVPN 기반 내부 네트워크를 구성하고 ROS1/ROS2 Action Programming으로 RTT와 Network Budget을 측정했습니다. HDL Graph SLAM 파라미터 튜닝, Isaac Sim 시뮬레이션, Unitree Go1 실험, 방사선 데이터 결합 3D 지도 제작을 수행했습니다.",
    summaryEn:
  ...
  },
  {
    ...
    roleKo: "자율주행 경로계획 & 주행제어",
    roleEn: "Autonomous Path Planning & Motion Control",
    periodKo: "2025.01 - 2025.02 | 2개월",
    periodEn: "Jan 2025 - Feb 2025 | 2 months",
    teamKo: "6명",
    teamEn: "6 members",
    summaryKo:
      "현재 위치 기반 글로벌 맵/heading 발행, 3D LiDAR 객체 인식, A* 글로벌 경로계획, Pure Pursuit 주행 제어, 커스텀 ROS2 토픽/서비스 기반 상태 제어를 구현했습니다. 원격 조작과 로봇 텔레메트리 송수신도 함께 구성했습니다.",
    summaryEn:
      "Implemented global map and heading publication from the robot pose, 3D LiDAR object detection, A* global path planning, Pure Pursuit motion control, and robot state control with custom ROS2 topics and services. Also configured remote control and robot telemetry exchange.",
  ...
  },
  {
    ...
    roleKo: "6족 보행 로봇 강화학습 & 센서 드라이버",
    roleEn: "Hexapod Reinforcement Learning & Sensor Drivers",
    periodKo: "2025.04 - 2025.05 | 2개월",
    periodEn: "Apr 2025 - May 2025 | 2 months",
    teamKo: "7명",
    teamEn: "7 members",
    summaryKo:
      "NVIDIA Isaac Sim에서 6족 보행 로봇 강화학습 환경을 구성하고, 다양한 센서 드라이버 관리와 데이터 발행 흐름을 담당한 재난지역 탐사 로봇 프로젝트입니다.",
    summaryEn:
      "A disaster exploration robot project where I configured a hexapod reinforcement-learning environment in NVIDIA Isaac Sim and handled multi-sensor driver management and data publishing.",
